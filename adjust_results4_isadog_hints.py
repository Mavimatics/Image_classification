...
#                                                                             
# PROGRAMMER: Abel Maviano Jonathan
# DATE CREATED: Tuesday, 7 November 2023                                 
# REVISED DATE: Tuesady, 7 November 2023
...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    with open(dogfile, "r") as infile:
        ...
        while line != "":
            ...
            # 4a. Process line by striping newline from line
            line = line.strip()

            #
            # 4b. adds dogname(line) to dogsnames_dic if it doesn't already exist 
    ...
    for key in results_dic:
        ...
        if results_dic[key][0] in dognames_dic:
            ...
            # 4c. Classifier Label IS NOT image of dog (e.g. NOT in dognames_dic)
        ...
        # Pet Image Label IS NOT a Dog image (e.g. NOT found in dognames_dic)
            ...
            # 4d. Classifier Label IS image of Dog (e.g. found in dognames_dic)
            # appends (0, 1)because only Classifier label is a dog
            if results_dic[key][1] in dognames_dic:
                results_dic[key].extend(0,1)
                                           
            # 4e. Classifier Label IS NOT image of Dog (e.g. NOT in dognames_dic)
